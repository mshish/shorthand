<!--
This is upstream Handy's README, kept for the platform notes, Linux
guidance and troubleshooting that are still accurate for Shorthand and
still maintained upstream. Shorthand's own README is README.md.

Sections describing Handy's releases, sponsors, roadmap, signing keys and
community are upstream's, not Shorthand's. Do not follow them expecting
Shorthand: this fork has no published installers yet.
-->
